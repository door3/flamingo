...
/**
 * Class PrimaryReviewController.
 */
class PrimaryReviewController extends ControllerBase  {
  ...
  public function content() {
    ...
    $url_webform_review = Url::fromRoute('entity.webform.canonical', ['webform' => '2020_annual_performance_manager'], ['query' => ['employee' => $employee->id(), 'department' => $employee->f_department->value, 'manager' => 'primary']]);
